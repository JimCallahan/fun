...
trait TupleOps[@specialized(Double, Int) Elem, Repr <: Tuple, Alt <: Tuple]
  ...
  /** Convert to a N-dimensional vector. */
  def toVecNd: VecNd

  /** Convert to a N-dimensional sparse vector. */
  def toVecSd: VecSd

  /** Convert to a 4-dimensional vector. */
  def toVec4d: Vec4d
  ...
  /** Convert to a 1-dimensional position. */
  def toPos1d: Pos1d
  ...
  /** Convert to a 1-dimensional index (ignoring the fractional part). */
  def toIndex1i: Index1i
